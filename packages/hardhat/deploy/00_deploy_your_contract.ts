...
const deployYourContract: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  await deploy("CheckIn", {
    from: deployer,
    // Contract constructor arguments
    args: ["0x8C71260fD3eC957faFf9F36Ef9d8C2B988c48E16", "0xb4Df20693EE59D64d8CCF828d8Aa0b88f4fC73eA"],
    log: true,
    // autoMine: can be passed to the deploy function to make the deployment process faster on local networks by
    // automatically mining the contract deployment transaction. There is no effect on live networks.
    autoMine: true,
  ...
  console.log("CheckInContract deployed to:", await checkInContract.getAddress());
};
...
deployYourContract.tags = ["CheckInContract"];
